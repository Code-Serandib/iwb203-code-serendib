...
import { Calculator, BookOpen, TrendingUp, Users, Network } from 'lucide-react'
import Layout from '@/components/layout/Layout'

const analyticsPages = [
  {
    title: "Common Equations",
    description: "Explore fundamental formulas for stakeholder analysis",
    icon: <Calculator className="w-12 h-12 mb-4" />,
    link: "analytics/common-equations",
